...
void CreateConsole()
{
    ...
    {
        puts("Window::Initialize......");
        puts(" ____                                       _       _       ");
        puts("|  _ \\  ___   ___  _ __ ___   ___ _ __  ___| |_ ___(_)_ __  ");
        puts("| | | |/ _ \\ / _ \\| '_ ` _ \\ / _ \\ '_ \\/ __| __/ _ \\ | '_ \\ ");
        puts("| |_| | (_) | (_) | | | | | |  __/ | | \\__ \\ ||  __/ | | | |         Running v2.3-BETA (v1_20)");
        puts("|____/ \\___/ \\___/|_| |_| |_|\\___|_| |_|___/\\__\\___|_|_| |_|         Platform Windows (11)");
        puts("");
    ...
    if (g_consoleHandle)
    {
        SetConsoleTextAttribute(g_consoleHandle, FOREGROUND_INTENSITY);
    }
}
#endif
//-----------------------------------------------------------------------------------------------
